...
class CharacterSourceEntityMapperTest {
    ...
    fun `transform character entity to character local model`() {
        ...
        val input = listOf(
            CharacterEntity(id = 1, name = "Name #1", url = "https://url/1", location = provideLocationEntity(), image = "image"),
            CharacterEntity(id = 2, name = "Name #2", url = "https://url/2", location = provideLocationEntity(), image = "image"),
            CharacterEntity(id = 3, name = "Name #3", url = "https://url/3", location = provideLocationEntity(), image = null),
            CharacterEntity(id = 4, name = "Name #4", url = "https://url/4", location = provideLocationEntity(), image = null)
        )

        val expected = listOf(
            CharacterLocalEntity(id = 1, name = "Name #1", url = "https://url/1", location = provideLocationLocalEntity(), image = "image", page = null, isFavorite = false),
            CharacterLocalEntity(id = 2, name = "Name #2", url = "https://url/2", location = provideLocationLocalEntity(), image = "image", page = null, isFavorite = false),
            CharacterLocalEntity(id = 3, name = "Name #3", url = "https://url/3", location = provideLocationLocalEntity(), image = null, page = null, isFavorite = false),
            CharacterLocalEntity(id = 4, name = "Name #4", url = "https://url/4", location = provideLocationLocalEntity(), image = null, page = null, isFavorite = false)
        )
